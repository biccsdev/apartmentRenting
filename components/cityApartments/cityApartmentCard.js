...
function ApartmentCard(data) {
    ...
    return (
        <div className='bg-transparent pt-10 p-8 md:w-2/5'>
            {(location === "LosCabosA") && (
                <div className='rounded p-3 shadow-lg overflow-hidden md:w-1/2 md:m-0 md:m-auto'>
            ...
            <p className='text-zinc-800 p-3'>{description}</p>
        </div>
    );
}
