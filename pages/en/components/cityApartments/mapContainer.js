...
const MapContainer = ({ location }) => {
    ...
    if (location === "MazatlanA") {
        return (
            <div className=" p-5 m-auto flex flex-wrap justify-center">
                <div className="w-4/5 m-auto h-px bg-gray-500"></div>
                <h1 className="w-full text-left font-bold p-5">Map</h1>
                <a href="https://goo.gl/maps/RPTWzFPets1jGm4N6?coh=178573&entry=tt" target="_blank">
    ...
    if (location === "MazatlanB") {
        return (
            <div className=" p-5 m-auto flex flex-wrap justify-center">
                <div className="w-4/5 m-auto h-px bg-gray-500"></div>
                <h1 className="w-full text-left font-bold p-5">Map</h1>
                <a href="https://goo.gl/maps/8wWh3mET5v2VrFQs8" target="_blank">
    ...
    if (location === "LosCabosA") {
        return (
            <div className=" p-5 m-auto flex flex-wrap justify-center">
                <div className="w-4/5 m-auto h-px bg-gray-500"></div>
                <h1 className="w-full text-left font-bold p-5">Map</h1>
                <a href="https://goo.gl/maps/oQe5o7gwyLU4ySgQA?coh=178573&entry=tt" target="_blank">
    ...
    if (location === "LosCabosB") {
        return (
            <div className=" p-5 m-auto flex flex-wrap justify-center">
                <div className="w-4/5 m-auto h-px bg-gray-500"></div>
                <h1 className="w-full text-left font-bold p-5">Map</h1>
                <a href="https://goo.gl/maps/dVRk9dpJzn3C8uXP9" target="_blank">
